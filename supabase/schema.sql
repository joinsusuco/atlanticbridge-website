...
COMMENT ON COLUMN quotes.service_type IS 'Type of service requested: product-sourcing, bulk-purchasing, vehicle-procurement, vehicle-shipping, cargo-shipping, gp-shipping';
